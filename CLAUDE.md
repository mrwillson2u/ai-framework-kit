...
If the framework documents (`01-Concept.md`, `02-PRD.md`, etc.) contain only placeholder text or `[TODO]` markers:

1. **Start the discovery process automatically**
2. Read `ProcessGuide/starter_questions.md` for the question flow
...
1. Read `AI-Context.md` for the file map and cross-references
...
```
Phase 1: Concept        → populates 01-Concept.md
Phase 2: UX & Discovery → populates 03-UX-Framework.md  
Phase 3: Requirements   → populates 02-PRD.md
Phase 4: Architecture   → populates 05-System-Architecture.md, 06-Data-Model.md, 07-API-Contract.md
Phase 5: Visual Design  → populates 04-Visual-Style-Guide.md
Phase 6: MVP & Roadmap  → populates 02-PRD.md (MVP section), 08-Decision-Log.md
```
...
- Log significant decisions in `08-Decision-Log.md` with reasoning

## File Reference

| File | Purpose |
|------|---------|
| `AI-Context.md` | Project context for AI tools (read order, cross-refs) |
| `ProcessGuide/starter_questions.md` | Full question set for discovery |
| `01-Concept.md` | Vision, problem, goals, users |
| `02-PRD.md` | Features, MVP scope, acceptance criteria |
| `03-UX-Framework.md` | User research, personas, platform choice |
| `04-Visual-Style-Guide.md` | Design tokens, colors, typography |
